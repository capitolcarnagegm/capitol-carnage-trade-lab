...
(function () {
  ...
  var state = {
    account: null, access: null, ownerAccounts: [], workspaces: [], activeWorkspace: null, authEmail: "", authChallenge: "", authError: "", onboarding: null,
  ...
  window.GMS = {
    loginOrLogout: function () { if (state.account) GMS.logout(); else { state.authChallenge = ""; state.authError = ""; render(); } },
