export const PRIDE_CALENDAR_2026 = [
  ...
  { date: "2026-01-18", time: "12:00 p.m. CT", category: "Trading", title: "Trading resumes", details: "Trading reopens at noon Central Time." },
  { date: "2026-02-28", time: "11:00 p.m. CT", category: "League administration", title: "2026 league dues deadline", details: "League dues must be paid by 11:00 p.m. Central Time." },
  { date: "2026-02-28", time: "11:59 p.m. CT", category: "Contracts", title: "Tag and holdout decisions due", details: "Franchise tag, transition tag, and holdout decisions must be submitted." },
  ...
  { date: "2026-03-01", time: "12:00 p.m. CT", category: "Rules", title: "Rule-change submissions open", details: "Owners may begin submitting proposed rule changes." },
  { date: "2026-03-07", time: "12:00 p.m. CT", category: "Rules", title: "Rule-change submissions close", details: "The submission window ends." },
  { date: "2026-03-07", time: "12:05 p.m. CT", category: "Rules", title: "Rule-change voting opens", details: "Voting begins on submitted proposals." },
  { date: "2026-03-14", time: "12:00 p.m. CT", category: "Rules", title: "Rule-change voting closes", details: "Voting ends on proposed changes." },
  ...
  { date: "2026-03-21", time: "12:00 p.m. CT", category: "Franchise tags", title: "Franchise-tag bidding closes", details: "Open bidding ends." },
  { date: "2026-03-21", time: "12:05 p.m. CT", category: "Franchise tags", title: "Tag match/decline window opens", details: "Franchises may begin matching or declining tag offers." },
  { date: "2026-03-28", time: "12:00 p.m. CT", category: "Franchise tags", title: "Tag match/decline deadline", details: "The franchise tag decision window closes." },
  ...
  { date: "2026-05-02", time: "12:00 p.m. CT", category: "Draft", title: "Rookie Draft begins", details: "The 2026 Pride Rookie Draft starts." },
  { date: "2026-07-25", time: "12:00 p.m. CT", category: "Free agency", title: "Free agency begins", details: "The annual free-agent period opens." },
  { date: "2026-08-01", time: "12:00 p.m. CT", category: "Free agency", title: "Free-agent nominations close", details: "The nomination period ends at noon Central Time." },
  ...
  { date: "2026-08-09", time: "11:59 p.m. CT", category: "Contracts", title: "Free-agent contract years due", details: "Contract years must be posted for acquired free agents; unspecified players receive one-year contracts." },
  { date: "2026-08-15", time: "12:00 p.m. CT", category: "Waivers", title: "Claims become available", details: "Teams may begin submitting claims." },
  { date: "2026-08-16", time: "11:59 p.m. CT", category: "Contracts", title: "Last-year extension deadline", details: "Deadline to extend players who are in the final year of their contracts." },
  { date: "2026-09-10", time: null, category: "Regular season", title: "NFL season begins", details: "The regular-season phase begins." },
  { date: "2026-10-08", time: "7:00 p.m. CT", category: "Contracts", title: "Non-final-year extension deadline begins", details: "Calendar milestone for extensions involving players who are not in the final year of their contracts." },
  { date: "2026-11-04", time: "10:59 p.m. CT", category: "Trading", title: "Pride trade deadline", details: "Trading closes for the regular season." }
];
...
export function currentCalendarStatus(now = new Date()) {
  ...
  return { today, phase, todayEvents, upcoming, recent, next, daysUntilNext, source: "2026 Pride League Calendar.xlsx", timezone: "America/Chicago" };
}
